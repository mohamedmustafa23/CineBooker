...
namespace Utilities.DBInitilizer
{
    public class DBInitializer : IDBInitializer
    {
        ...
        public void Initialize()
        {
            try
            {
                ...
                {
                    _roleManager.CreateAsync(new(UserRole.SUPER_ADMIN_ROLE)).GetAwaiter().GetResult();
                    _roleManager.CreateAsync(new(UserRole.ADMIN_ROLE)).GetAwaiter().GetResult();
                    _roleManager.CreateAsync(new(UserRole.EMPLOYEE_ROLE)).GetAwaiter().GetResult();
                    _roleManager.CreateAsync(new(UserRole.CUSTOMER_ROLE)).GetAwaiter().GetResult();
                    ...
                    _userManager.AddToRoleAsync(user!, UserRole.SUPER_ADMIN_ROLE).GetAwaiter().GetResult();
                }
            }
            catch (Exception ex)
            {
